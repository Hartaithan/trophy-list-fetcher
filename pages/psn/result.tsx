...
import { IPSNFetchResponse as IResponse, IRow } from "@/models/TrophyModel";
import { GetServerSideProps, InferGetServerSidePropsType } from "next";
import Image from "next/image";
import { ChangeEventHandler, useState } from "react";
import styles from "@/styles/PSNResult.module.css";

const API_URL = process.env.NEXT_PUBLIC_API_URL;

interface IPSNResultPageProps {
  result: IResponse;
}
...
PSNResultPage.Layout = PSNProfilesLayout;

export default PSNResultPage;
